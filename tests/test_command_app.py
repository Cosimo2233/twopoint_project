...
class CommandAppTest(unittest.TestCase):
    ...
    def test_center_flash_track_config_loads_as_implemented_mode(self) -> None:
        ...
        self.assertEqual(task_config.closed_loop.target_width_cm, 29.7)
        self.assertEqual(task_config.closed_loop.target_height_cm, 21.0)
        self.assertEqual(task_config.closed_loop.x_angle_scale, 1.0)
        self.assertEqual(task_config.closed_loop.y_angle_scale, -1.0)
